...
ActiveRecord::Schema.define(version: 20161112193644) do
  ...
  create_table "school_admins", force: :cascade do |t|
    ...
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
    t.index ["email"], name: "index_school_admins_on_email", unique: true, using: :btree
    t.index ["reset_password_token"], name: "index_school_admins_on_reset_password_token", unique: true, using: :btree
  end
